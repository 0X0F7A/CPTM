...
import net.entityCatPig.testmod.client.model.CPTMGuardianModel;
...
public class CPTMGuardianRenderer extends BipedEntityRenderer<GuardianEntity, CPTMGuardianModel<GuardianEntity>> {
    private static final Identifier ZOMBIE_LOCATION = new Identifier(TestMod.MOD_ID,"textures/entity/cptmguardian.png");
    ...
    public CPTMGuardianRenderer(EntityRendererFactory.Context p_i46143_1_) {
        super(p_i46143_1_, new CPTMGuardianModel<>(p_i46143_1_.getPart(ModEntityTypes.MODEL_GUARDIAN_LAYER)), 0.5F);
        this.addFeature(new ArmorFeatureRenderer<>(this, new BipedEntityModel(p_i46143_1_.getPart(ModEntityTypes.MODEL_GUARDIAN_LAYER_IA)), new BipedEntityModel(p_i46143_1_.getPart(ModEntityTypes.MODEL_ELDER_GUARDIAN_LAYER_OA))));
    }

    public boolean shouldRender(GuardianEntity p_225626_1_, Frustum p_225626_2_, double p_225626_3_, double p_225626_5_, double p_225626_7_) {
    ...
    public void render(GuardianEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, VertexConsumerProvider p_225623_5_, int p_225623_6_) {
    ...
    protected void setupTransforms(GuardianEntity p_225621_1_, MatrixStack p_225621_2_, float p_225621_3_, float p_225621_4_, float p_225621_5_) {
    ...
    public Identifier getTexture(GuardianEntity p_110775_1_) {
