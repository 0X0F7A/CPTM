...
public class CPTMSpiderModel<T extends SpiderEntity> extends PlayerEntityModel<T> {

    public CPTMSpiderModel(ModelPart mdp) {
        this(mdp, true);
    }
    ...
    public CPTMSpiderModel(ModelPart root, boolean p_i46303_2_) {
