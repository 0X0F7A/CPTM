...
public class CPTMWitherSkeletonModel<T extends MobEntity & RangedAttackMob> extends PlayerEntityModel<T> {
    public CPTMWitherSkeletonModel(ModelPart mdp) {
        this(mdp, true);
    }

    public CPTMWitherSkeletonModel(ModelPart p_i46303_1_, boolean p_i46303_2_) {
