...
public class CPTMVindicatorModel<T extends VindicatorEntity> extends PlayerEntityModel<T> {
    public CPTMVindicatorModel(ModelPart mdp) {
        this(mdp, true);
    }

    public CPTMVindicatorModel(ModelPart p_i46303_1_, boolean p_i46303_2_) {
