...
public class CPTMSnowGolemModel<T extends SnowGolemEntity> extends PlayerEntityModel<T> {
    public CPTMSnowGolemModel(ModelPart mdp) {
        this(mdp, true);
    }

    public CPTMSnowGolemModel(ModelPart p_i46303_1_, boolean p_i46303_2_) {
