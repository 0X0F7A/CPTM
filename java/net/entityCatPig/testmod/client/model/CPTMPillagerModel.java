...
public class CPTMPillagerModel<T extends PillagerEntity> extends PlayerEntityModel<T> {
    public CPTMPillagerModel(ModelPart mdp) {
        this(mdp, true);
    }

    public CPTMPillagerModel(ModelPart p_i46303_1_, boolean p_i46303_2_) {
    ...
    public void setAngles(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
        ...
        }else if (abstractillagerentity$armpose == IllagerEntity.State.BOW_AND_ARROW) {
        ...
        } else if (abstractillagerentity$armpose == IllagerEntity.State.CROSSBOW_HOLD) {
            CrossbowPosing.hold(this.rightArm, this.leftArm, this.head, true);
        } else if (abstractillagerentity$armpose == IllagerEntity.State.CROSSBOW_CHARGE) {
            CrossbowPosing.charge(this.rightArm, this.leftArm, p_225597_1_, true);
