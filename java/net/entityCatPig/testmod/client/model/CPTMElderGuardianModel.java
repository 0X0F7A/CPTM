...
public class CPTMElderGuardianModel<T extends ElderGuardianEntity> extends PlayerEntityModel<T> {

    public CPTMElderGuardianModel(ModelPart mdp) {
        this(mdp, true);
    }
    private final ModelPart[] tailParts;
    public float NSwimAmount = -0.1F;

    public CPTMElderGuardianModel(ModelPart root, boolean p_i46303_2_) {
