...
public class CPTMStrayModel<T extends MobEntity & RangedAttackMob> extends PlayerEntityModel<T> {
    public CPTMStrayModel(ModelPart mdp) {
        this(mdp, true);
    }

    public CPTMStrayModel(ModelPart p_i46303_1_, boolean p_i46303_2_) {
