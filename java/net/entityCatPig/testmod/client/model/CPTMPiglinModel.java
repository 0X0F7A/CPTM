...
public class CPTMPiglinModel<T extends PiglinEntity> extends PlayerEntityModel<T> {
    public CPTMPiglinModel(ModelPart mdp) {
        this(mdp, true);
    }

    public CPTMPiglinModel(ModelPart p_i46303_1_, boolean p_i46303_2_) {
    ...
    protected void animateArms(T p_230486_1_, float p_230486_2_) {
        if (this.handSwingProgress > 0.0F && p_230486_1_ instanceof PiglinEntity && ((PiglinEntity)p_230486_1_).getActivity() == PiglinActivity.ATTACKING_WITH_MELEE_WEAPON) {
