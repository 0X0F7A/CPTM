...
public class CPTMSilverfishModel<T extends SilverfishEntity> extends PlayerEntityModel<T> {
    public CPTMSilverfishModel(ModelPart mdp) {
        this(mdp, true);
    }

    public CPTMSilverfishModel(ModelPart p_i46303_1_, boolean p_i46303_2_) {
