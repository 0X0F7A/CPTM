...
public class CPTMZombiefiedPiglinModel<T extends ZombifiedPiglinEntity> extends PlayerEntityModel<T> {
    public CPTMZombiefiedPiglinModel(ModelPart mdp) {
        this(mdp, true);
    }

    public CPTMZombiefiedPiglinModel(ModelPart p_i46303_1_, boolean p_i46303_2_) {
