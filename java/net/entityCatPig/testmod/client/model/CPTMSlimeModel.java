...
public class CPTMSlimeModel<T extends SlimeEntity> extends PlayerEntityModel<T> {

    public int sizeIntIns;

    public ModelPart tntBlock;
    public CPTMSlimeModel(ModelPart mdp) {
        this(mdp, true);
    }

    public CPTMSlimeModel(ModelPart root, boolean p_i46303_2_) {
