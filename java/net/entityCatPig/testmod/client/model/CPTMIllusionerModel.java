...
public class CPTMIllusionerModel<T extends IllusionerEntity> extends PlayerEntityModel<T> {
    public CPTMIllusionerModel(ModelPart mdp) {
        this(mdp, true);
    }
    public CPTMIllusionerModel(ModelPart p_i46303_1_, boolean p_i46303_2_) {
