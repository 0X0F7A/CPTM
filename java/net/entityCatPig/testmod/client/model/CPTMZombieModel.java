...
public class CPTMZombieModel<T extends ZombieEntity> extends PlayerEntityModel<T> {
    public CPTMZombieModel(ModelPart mdp) {
        this(mdp, true);
    }

    public CPTMZombieModel(ModelPart p_i46303_1_, boolean p_i46303_2_) {
